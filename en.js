...
export default {
  ...
  "Notifications_entry.like": "%{username} liked your post.",
  "Notifications_entry.reply": "%{username} replied to your post.",
  "Notifications_chat.tagged": "%{username} tagged you in chat.",
  "Notifications_chat.reply": "%{username} replied to your message.",
  "Notifications_user.follow": "%{username} started following you.",
  "Notifications_message.like": "%{username} liked your message.",
  "Cancel": "Cancel",
